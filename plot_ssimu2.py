...
ax.set_ylim(round(overall_min - 15, -1), 100)
ax.set_xlabel('Frame', fontdict={'fontsize': 18, 'color': colors['text']})
ax.set_ylabel('SSIMULACRA2 Score', fontdict={'fontsize': 22, 'color': colors['text']})
ax.set_title('SSIMULACRA2 Scores per Frame', fontdict={'fontsize': 22, 'color': colors['text']})
...
legend = ax.legend(loc='lower left', facecolor=colors['legend_face'], edgecolor=colors['legend_edge'], framealpha=0.7)
